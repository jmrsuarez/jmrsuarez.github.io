...
//	var CANVAS_PADDING = 60;
  var CANVAS_PADDING = 2;
	...
	function drawFlip( flip ) {
		...
		var verticalOutdent = 50 * strength;
		...
		context.moveTo(foldX, 0);
		context.lineTo(foldX, PAGE_HEIGHT);
		context.quadraticCurveTo(foldX, PAGE_HEIGHT + (verticalOutdent * 4), foldX - foldWidth, PAGE_HEIGHT + verticalOutdent);
		context.lineTo(foldX - foldWidth, -verticalOutdent);
		context.quadraticCurveTo(foldX, -verticalOutdent * 4, foldX, 0);
